...
|qualityCheck|Body|"yes"/"no"|"no"|This will detect if an ID card is black and white. Currently, this feature is available only for PAN and Aadhaar cards|Aadhar, PAN, Passport, Driving License, Voter ID. |
