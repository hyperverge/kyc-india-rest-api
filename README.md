...
| maskAadhaarText         | Body           | "yes"/"no" |  "no"   | ? passed in getRecognitionRequest() sent after ctpn result is achieved.                                                                                                                                                                |
| returnOnlyImage         | Body           | "yes"/"no" |  "no"   | ? passed in getRecognitionRequest() sent after ctpn result is achieved.                                                                                                                                                                      |
| outputImageBase64         | Body           | "yes"/"no" |  "no"   | getBase64FaceImageIfPresent function used.                                                                                                                                                           |
| expandQR         | Body           | "yes"/"no" |  "no"   | ? passed in getRecognitionRequest() sent after ctpn result is achieved.                                                                                                                                                                    |
| allowOnlyHorizontal         | Body           | "yes"/"no" |  "no"   | Only horizontal documents to be sent to ctpn queue.                                                                                                                                                        |
| allowOnlyCompleteCard         | Body           | "yes"/"no" |  "no"   | ? passed in getDetectionRequest() for pushing to detection queue.                                                                                                                                                 |
| allowOnlyLiveDocument         | Body           | "yes"/"no" |  "no"   |  ? passed in getDetectionRequest() for pushing to detection queue.                                                                                                                                                             |
| rejectPhotoOnPhoto         | Body           | "yes"/"no" |  "no"   | ?  passed in getDetectionRequest() for pushing to detection queue. |
| detectMinor         | Body           | "yes"/"no" |  "no"   | ? passed in getRecognitionRequest() sent after ctpn result is achieved.                                                                                                                                                            |
| rejectBlur         | Body           | "yes"/"no" |  "no"   | ?  passed in getCtpnRequest() for pushing to Ctpn queue.                                                                                                                                                             |
| detectPANSignature         | Body           | "yes"/"no" |  "no"   | ? passed in getRecognitionRequest() sent after ctpn result is achieved.                                                                                                                                                         |
| readBarcode         | Body           | "yes"/"no" |  "no"   |  ? passed in getRecognitionRequest() sent after ctpn result is achieved.                                                                                                                                                            |
