...
## Sample Code
 ...
 - **readKYC**
        ...
        # Using Auth Token with Multipart
        curl -X POST https://ind-docs.hyperverge.co/v2.0/readKYC \
 ...
 - **readPAN**
        ...
        # Using Auth Token with Image Url
        curl -X POST https://ind-docs.hyperverge.co/v2.0/readPAN \
		  -H 'Authorization: <Auth Token>' \
		  -H 'content-type: multipart/form-data;\
		  -F 'url=https://pan_pdf_or_image_url'
 ...
 - **readAadhaar**	
        ...
        # Multipart Upload of Aadhaar Image
 ...
 - **readPassport**
        ...
        # Multipart Upload of Passport Image
 ...
 - **readVoterID**
        ...
        # Multipart Upload of VoterId Image
